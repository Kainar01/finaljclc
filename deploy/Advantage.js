...
class Advantage extends React.Component{
    ...
    render(){
        ...
        <form onSubmit={this.handleSubmit} method="POST" action="email.php">
            ...
            <div><input type="text" name="myEmail" className="form-control" required/></div>
            <input type="text" id="website" name="website"/>
            <div><label>Вопрос:</label></div>
            <div><textarea cols="40" rows="5" name="myMessage" className="form-control" placeholder="kotak" value="lolol" required></textarea></div>
